...
public class UpdateRoom extends JFrame {
    ...
    public static void main(String[] args){
        ...
        JLabel lblActivity = new JLabel("Availability: ");
        lblActivity.setBounds(27,187,90,14);
        ...
        txt_Ava.setBounds(160,237,140, 20);
        ...
        txt_Room.setBounds(160,237,140,20);
        ...
        btnUpdate.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e ) throws NumberFormatException {
                try{
                    conn c = new conn();
                    String str = "Update room st clean_status= '"+txt_Status.getText()+"' where room_number= "+txt_Room.getText();
